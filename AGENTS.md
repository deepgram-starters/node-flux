...
Node.js demo app for Deepgram Flux.
...
```
feat(node-flux): add diarization support
fix(node-flux): resolve WebSocket close handling
refactor(node-flux): simplify session endpoint
